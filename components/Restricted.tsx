...
const Restricted: React.FC<RestrictedProps> = ({ restoreTime }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-700">
      ...
      <div className="mt-12 bg-gray-900 border border-red-500/20 rounded-3xl p-6 w-full max-w-[300px] space-y-2">
      ...
      <p className="mt-auto text-[10px] text-gray-600 font-bold uppercase tracking-widest mb-4">
